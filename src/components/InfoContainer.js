      ...
      <div className="info-container__main">
        ...
        <div className="info-container__content">
          ...
          <p className="paragraph">
            {writeUp.block2.summary}{" "}
            <a className="info-container__link" href={writeUp.block2.link}>
