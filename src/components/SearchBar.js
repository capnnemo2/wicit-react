    ...
    if (this.state.address === "" && this.state.coordinates === null) {
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition((position) => {
          this.props.handleLocation("Current Location", {
  ...
  render() {
    return (
      <form className="search-form" onSubmit={this.handleLocation}>
          ...
          {({
            ...
            <>
              ...
              <div className="autocomplete-dropdown-container search-form__dropdown">
                {loading && (
                  <div className="search-form__suggestions">Loading...</div>
                )}
        ...
        <button
          className="search-form__button btn btn--orange u-margin-bottom-small"
          type="submit"
